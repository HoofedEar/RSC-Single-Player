...
public class mudclient extends Shell {
    ...
    public void createLoginPanels() {
        ...
        controlRegisterTerms = panelRegisterUser.addTextListScrollable(gameWidth / 2 - (400 / 2), y + 20, 400, 190, 1, 1000, true);
    ...
    public void writeTerms(Menu panel, int control) {
        ...
        panel.addListEntry("", control);
        panel.addListEntry("This version is a fork of the hard work Sean Niemann / Zoso did", control);
        panel.addListEntry("to make this a serverless, single-player experience. This is a", control);
        panel.addListEntry("heavily modified RSCL base, with stripped networking and packet", control);
        panel.addListEntry("handling. It had taken Sean nearly 6 months to complete this and", control);
        panel.addListEntry("create new loading routines. Thank you, Sean.", control);
        panel.addListEntry("", control);
        panel.addListEntry("@yel@This game is still in active development. You may experience weird", control);
        panel.addListEntry("@yel@bugs, or missing features. If you do find any of these please let me", control);
        panel.addListEntry("@yel@know on Github: https://github.com/HoofedEar/RSC-Single-Player", control);
        panel.addListEntry("", control);
        panel.addListEntry("", control);
        ...
        panel.addListEntry("", control);
        panel.addListEntry("Copyright (C) 2019-2023 Sean Niemann", control);
        panel.addListEntry("Copyright (C) 2023 Chris Vergilio", control);
        panel.addListEntry("", control);
